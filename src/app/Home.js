...
function Home() {
  ...
  useEffect(() => {
    ...
    TweenMax.to(block2, 2, {
      x: "-180",
      y: "200",
      scale: "1.2",
      ease: Expo.easeInOut,
    });
    TweenMax.to(block3, 2, {
      x: "180",
      y: "-340",
      scale: "1.6",
      ease: Expo.easeInOut,
    });
    TweenMax.to(block4, 2, {
      x: "580",
      y: "140",
      scale: "0.8",
      ease: Expo.easeInOut,
  ...
  return (
    ...
    // <!-- ========== --> */}
      ...
      <section
        id="experience"
        ref={(el) => (thirdSection = el)}
        class="third-section showreel"
      >
        <h1 class="title-1" ref={(el) => (title = el)}>
          MY-EXPERIENCE
        </h1>
        <div class="experience">
          <div class="apps" ref={(el) => (apps = el)}>
            <div class="first-app col-lg-3 col-md-5 col-sm-12">
              <img src={IMAGES.cssLogo} class="app-logo app-2" alt="css logo" />
              <h2>HTML-CSS</h2>
              <p>Visual Design</p>
            </div>
